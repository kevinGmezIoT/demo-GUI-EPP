...
import queue #personalized
import threading #personalized
...
class LoadStreams:  # multiple IP or RTSP cameras
    def __init__(self, sources='streams.txt', img_size=640, stride=32):
        ...
        for i, s in enumerate(sources):
            ...
            w = int(self.cap.width)
            h = int(self.cap.height)
            self.fps = self.cap.fps % 100

            self.imgs[i] = self.cap.read()  # guarantee first frame
